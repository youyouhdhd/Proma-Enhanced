...
### 2026-09-24：Fork 仓库首页说明

- 中英文 README 首页统一先说明 Fork 身份、独立版本与下载来源，并用五个用户关注点概括 Connector/多项目、远程连接、全局 Agent 能力、模型与 QuickAsk、长任务体验。
- 上游原有通用产品介绍保留在首页后半段并标明来源。GitHub 仓库简介、主页链接与主题词同步指向 Enhanced Fork 和本仓库最新 Release。
- 这是 v1.16.2 发布后的文档提交；根工作区/Electron 开发版本递增到 1.16.3，不移动 v1.16.2 标签。
