...
> - **MCP 共享与远程访问**：一个 Connector 动态管理多个项目，按项目授权 Direct 读写与 Shell，支持独立 ngrok 配置、加密 Credential、已有 Endpoint 安全复用、多模型异步分析，以及 ChatGPT 首次连接能力说明和可选 Agent 动作委派；当前稳定版本与升级说明见 [v1.13.1 发布说明](./release-notes/v1.13.1.md)；
