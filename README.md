...
> - **MCP 共享与远程访问**：一个 Connector 动态管理多个项目，按项目授权 Direct 读写与 Shell，支持独立 ngrok 配置、加密 Credential、已有 Endpoint 安全复用及多模型异步分析；当前稳定版本与升级说明见 [v1.12.2 发布说明](./release-notes/v1.12.2.md)；
